(() => {
  ...
  const copy = {
    es: {
      ...
      theCoach: 'EL ENTRENADOR', aboutRole: 'Entrenador de pádel', aboutLead: 'John convierte cada error en una corrección clara: qué cambiar, cómo hacerlo y cuándo aplicarlo. Un enfoque técnico, práctico y cercano para avanzar con intención.',
      ...
      footerLocation: 'Q3 Padel · Sant’Ana do Livramento', footerRights: 'Todos los derechos reservados.', photoCredit: 'Fotografías reales:', stickySmall: 'COORDINACIÓN DIRECTA', stickyCta: 'Reservar por WhatsApp',
    ...
    pt: {
      ...
      theCoach: 'O TREINADOR', aboutRole: 'Treinador de padel', aboutLead: 'John transforma cada erro em uma correção clara: o que mudar, como fazer e quando aplicar. Uma abordagem técnica, prática e próxima para avançar com intenção.',
      ...
      footerLocation: 'Q3 Padel · Sant’Ana do Livramento', footerRights: 'Todos os direitos reservados.', photoCredit: 'Fotografias reais:', stickySmall: 'CONTATO DIRETO', stickyCta: 'Agendar pelo WhatsApp',
